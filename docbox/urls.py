...
urlpatterns = patterns('',
    ...
    (r'^writer/project(?P<project_id>[a-z0-9\/\.]{0,300})/(?P<filename>[a-z0-9\/\-\.]{0,300}(.jpg|.png|.gif))$', 'docbox.views.static_serve'),
    ...
    (r'^mnml/upload/(?P<project_id>[a-z0-9\.]{0,300})/$', 'docbox.views.upload'),
